...
function App() {
  ...
  return (
    <main className="page-wrap px-4 pb-8 pt-14">
      ...
      <section className="island-shell rise-in relative overflow-hidden rounded-[2rem] px-6 py-10 sm:px-10 sm:py-14 grid gap-10 lg:grid-cols-[1fr_1.2fr] items-center">
